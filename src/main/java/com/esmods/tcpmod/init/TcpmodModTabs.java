...
public class TcpmodModTabs {
	...
	public static final RegistryObject<CreativeModeTab> CUSTOM_STONES = REGISTRY.register("custom_stones",
			() -> CreativeModeTab.builder().title(Component.translatable("item_group.tcpmod.custom_stones")).icon(() -> new ItemStack(TcpmodModItems.CUSTOM_STONE.get())).displayItems((parameters, tabData) -> {
