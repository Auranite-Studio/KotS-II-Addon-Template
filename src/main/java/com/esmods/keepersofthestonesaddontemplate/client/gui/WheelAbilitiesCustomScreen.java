...
public class WheelAbilitiesCustomScreen extends AbstractContainerScreen<WheelAbilitiesCustomMenu> implements PowerTemplateModScreens.ScreenAccessor {
	...
	private ImageButton imagebutton_ability_1;
	private ImageButton imagebutton_ability_2;
	private ImageButton imagebutton_ability_3;
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int mouseX, int mouseY) {
		...
		guiGraphics.blit(ResourceLocation.parse("power_template:textures/screens/wheel_of_abilities.png"), this.leftPos + -1, this.topPos + 0, 0, 0, 192, 192, 192, 192);
	...
	public void init() {
		...
		imagebutton_wheel_button_1 = new ImageButton(this.leftPos + 140, this.topPos + 154, 10, 7,
				new WidgetSprites(ResourceLocation.parse("power_template:textures/screens/wheel_button_1.png"), ResourceLocation.parse("power_template:textures/screens/wheel_button_1_highlight.png")), e -> {
					int x = WheelAbilitiesCustomScreen.this.x;
					int y = WheelAbilitiesCustomScreen.this.y;
