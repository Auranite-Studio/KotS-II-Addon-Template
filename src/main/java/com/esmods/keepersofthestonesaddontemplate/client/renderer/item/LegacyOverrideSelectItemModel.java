package com.esmods.keepersofthestonesaddontemplate.client.renderer.item;
...
public class LegacyOverrideSelectItemModel implements ItemModel {
	...
	public static void registerItemModelTypes(RegisterItemModelsEvent event) {
		event.register(ResourceLocation.parse("power_template:legacy_overrides"), LegacyOverrideSelectItemModel.Unbaked.MAP_CODEC);
	}
}
